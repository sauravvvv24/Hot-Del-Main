              ...
              <div className="relative z-10 h-full flex flex-col justify-center space-y-8">
                ...
                <div className="text-center lg:text-left">
                  <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                    Grow Your Business with Hot-Del
                  </h2>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="text-center p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                    ...
                    <div className="text-blue-200 text-sm">Seller Support</div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                    ...
                    <span className="text-sm">Reach 500+ hotels nationwide</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                    ...
                    <span className="text-sm">Premium seller benefits</span>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-white/20 to-white/10 p-6 rounded-2xl border border-white/30 backdrop-blur-sm">
                  ...
                  <blockquote className="text-sm font-medium mb-3">
                    "Hot-Del helped us expand our reach to hotels across the country. Excellent platform!"
                  </blockquote>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-semibold text-sm">Amit Singh</p>
                      <p className="text-blue-200 text-xs">CEO, FreshSupply Co.</p>
                    </div>
                  </div>
                </div>
              </div>
