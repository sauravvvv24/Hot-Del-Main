...
const SellerSignup = () => {
  ...
  const handleFinalSignup = async () => {
    setIsLoading(true);
    try {
      await axios.post('http://localhost:3000/api/auth/seller-register', {
        name: form.name,
        email: form.email,
            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="mb-8 text-center">
                ...
                <p className="text-gray-600 text-lg">
                  Start selling to premium hotels and grow your business
                </p>
              </div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-center space-y-8">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-blue-100 text-lg">
                    Join 1000+ sellers already growing their business
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4 p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Zero Setup Fees</h3>
                      <p className="text-blue-100 text-sm">Start selling immediately with no upfront costs</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-sm">Protected transactions and fraud prevention</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-sm">Dedicated seller support team</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-white/20 to-white/10 p-6 rounded-2xl border border-white/30 backdrop-blur-sm">
                  ...
                  <blockquote className="text-lg font-medium mb-4">
                    "Hot-Del increased my sales by 40% in just 3 months. The platform is amazing!"
                  </blockquote>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200 text-sm">Electronics Seller</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-blue-200 text-sm">Avg. Revenue Growth</div>
                  </div>
                </div>
              </div>
            </div>
